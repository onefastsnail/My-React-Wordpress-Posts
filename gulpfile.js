...
var paths = {
    sass: {
        src: ['./public/assets/css/scss/**/*.scss'],
        dist: './public/assets/dist/css/'
    },
    js: {
        src: ['./public/assets/js/*.js', './public/assets/js/components/*.js'],
        dist: './public/assets/dist/js/'
    },
    react: {
        app: './public/assets/react/App.js',
        src: ['./public/assets/react/**/*.js'],
        dist: './public/assets/dist/react/'
    }
};
